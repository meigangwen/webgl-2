...
export default function Home() {
   ...
   // define the leva UI
   const {fov,x,y,z,angleX,angleY,angleZ,scaleX,scaleY,scaleZ} = useControls("3D Transformation", {
    fov: {value:60, min:1, max:179, step:1},
    x: { value:-150, min:0, max:2000, step: 1},
    y: { value:0, min:0, max:1000, step: 1},
    z: { value:-360, min:-500, max:1000, step: 1},
    angleX: {value:190, min:0,max:360,step:1},
    angleY: {value:40, min:0,max:360,step:1},
    angleZ: {value:30, min:0,max:360,step:1},
  ...
  useEffect(() => {
    main()
  },[x,y,z,angleX,angleY,angleZ,scaleX,scaleY,scaleZ,fov])
